//[DXQL](../../../index.md)/[ru.council.dxql.exceptions](../index.md)/[ProcessingException](index.md)

# ProcessingException

[jvm]\
open class [ProcessingException](index.md) : [RuntimeException](https://docs.oracle.com/javase/8/docs/api/java/lang/RuntimeException.html)

## Constructors

| | |
|---|---|
| [ProcessingException](-processing-exception.md) | [jvm]<br>constructor(s: [String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html)) |
