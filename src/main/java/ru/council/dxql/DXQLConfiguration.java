...
/**
 * <p>
 *     Класс конфигурации DXQL.
 *     Хранит в себе описания:
 *     <ul>
 *         <li>Глобальных входных параметров</li>
 *         <li>Схемы БД, которую следует использовать при выполнении запросов.</li>
 *         <li>Локаль, которая используется</li>
 *         <li>Временные таблицы, необходимые для хранения оперативных данных</li>
 *         <li>Описания запросов. Не могут иметь параметров</li>
 *         <li>Описания шаблонов запросов. Запросов с параметрами</li>
 *         <li>Сами запросы. То есть SQL часть и описание перехода от записей представления к TargetFormat</li>
 *     </ul>
 *
 *     Схема бд, если указана и начинается с '${', а оканчивается на '}', то получается из глобальных параметров.
 *     К примеру:
 *     <pre>
 *         ${my_schema_var} -> globalParameters['my_schema_var']
 *     </pre>
 *
 *     Аналогично верно для
 * </p>
 *
 * @author a.pesterev
 */
